  ...
  return (
    <div className="panel flex flex-col">
      <div className="flex items-center justify-between px-4 py-3 border-b border-mirage-border">
        <span className="text-[10px] font-mono uppercase tracking-[0.08em] text-mirage-muted">Live Feed</span>
          ...
          {transactions.slice(0, 8).map((tx, i) => (
            <div
              ...
              className={clsx(
                ...
                tx.is_flagged && 'bg-mirage-danger/[0.04] border-l-2 border-l-mirage-danger'
              )}
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[12px] text-white truncate leading-snug">{tx.merchant || '—'}</p>
                <p className={clsx('text-[10px] font-mono uppercase tracking-wide', CAT_COLOR[tx.category] || CAT_COLOR.unknown)}>
                  {tx.category}
                </p>
              </div>
              ...
              <div className="text-right flex-shrink-0">
                ...
                {tx.is_flagged && (
                  <p className="text-[9px] font-mono text-mirage-danger tracking-wider">FLAGGED</p>
                )}
              </div>
            </div>
          ))}
